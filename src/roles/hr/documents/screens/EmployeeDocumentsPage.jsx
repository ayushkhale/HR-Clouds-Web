...
// deletes from there. The same panel is the "Documents" tab of the employee
// profile. The chosen person lives in the URL (?user=) so the page can be
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl w-full mx-auto space-y-6">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">Open anyone’s document file to upload, link, verify, replace or remove documents.</p>
          </div>
        ...
        {userId ? (
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-xs">
            <DocEmptyState icon={HiFolderOpen} title="Choose an employee" message="Pick someone above to see every document in their file — including ones in review, rejected, and older versions." />
          </div>
        )}
      </main>
    </>
