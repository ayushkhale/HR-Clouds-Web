  ...
  const getNavSections = () => {
      ...
      return [
        ...
        },
        {
          ...
          items: [
            ...
            link("Document Home", "/dashboard/hr/my-documents/all", HiCollection),
            ...
            link("Requested From Me", "/dashboard/hr/my-document-requests", HiClipboardList),
            link("Blank Forms", "/dashboard/hr/forms", HiTemplate),
          ],
        },
      ];
    }
      ...
      return [
        ...
        },
        {
          ...
          items: [
            ...
            link("Document Home", `${M}/my-documents/all`, HiCollection),
            link("My Documents", `${M}/my-documents`, HiFolderOpen),
            link("Company Documents", `${M}/company-documents`, HiOfficeBuilding),
            link("Requested From Me", `${M}/my-document-requests`, HiClipboardList),
            link("Blank Forms", `${M}/forms`, HiTemplate),
          ],
        },
      ];
    }
    ...
    return [
      ...
      },
      {
        ...
        forceDropdown: true,
        items: [
          link("Document Home", `${E}/documents/all`, HiCollection),
          link("My Documents", `${E}/documents`, HiFolderOpen),
          link("Company Documents", `${E}/company-documents`, HiOfficeBuilding),
          link("Requested From Me", `${E}/document-requests`, HiClipboardList),
          link("Blank Forms", `${E}/forms`, HiTemplate),
        ],
      },
    ];
  };
